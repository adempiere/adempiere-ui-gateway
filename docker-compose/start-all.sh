...
AUTH_array[$ZOOKEEPER]="12b-zookeeper_service_without_healthcheck.yml"
AUTH_array[$KAFKA]="13a-kafka_service_with_healthcheck.yml"
...
AUTH_array[$OPENSEARCH_GATEWAY_RS]="16a-opensearch_gateway_rs_service_auth.yml"
...
CACHE_array[$GRPC_PROXY]="10a-grpc_proxy_service_cache.yml"
CACHE_array[$VUE_UI]="11a-vue_ui_service.yml"
CACHE_array[$ZOOKEEPER]="12a-zookeeper_service_with_healthcheck.yml"
CACHE_array[$KAFKA]="13a-kafka_service_with_healthcheck.yml"
...
CACHE_array[$OPENSEARCH_GATEWAY_RS]="16b-opensearch_gateway_rs_service_cache.yml"
...
STANDARD_array[$ZOOKEEPER]="12b-zookeeper_service_without_healthcheck.yml"
STANDARD_array[$KAFKA]="13b-kafka_service_without_healthcheck.yml"
...
STANDARD_array[$OPENSEARCH_GATEWAY_RS]="16d-opensearch_gateway_rs_service_standard.yml"
...
STORAGE_array[$S3_GATEWAY_RS]="04c-s3_gateway_rs_service_storage.yml"
