...
9. [Service: adempiere-landing-page](#service-adempiere-landing-page)
...
### Placeholder Migration Steps

Once source repository is identified:
1. Fork/create repository under `adempiere` organization
2. Modify `.github/workflows/publish.yml` similar to other services
3. Change Docker login from Docker Hub secrets to GitHub Container Registry
4. Update image tags to `ghcr.io/adempiere/adempiere-s3-gateway`
5. Create GitHub Release with tag (suggested: `1.2.8`)
6. Verify publication: `docker pull ghcr.io/adempiere/adempiere-s3-gateway:1.2.8`
7. Update `adempiere-ui-gateway` env_template.env line 117 (Phase 4)
...
2. Modify `.github/workflows/publish.yml` similar to other services
3. Change Docker login from Docker Hub secrets to GitHub Container Registry
4. Update image tags to `ghcr.io/adempiere/adempiere-dictionary-service`
5. Create GitHub Release with tag (suggested: `1.5.6`)
6. Verify publication: `docker pull ghcr.io/adempiere/adempiere-dictionary-service:1.5.6`
7. Update `adempiere-ui-gateway` env_template.env line 221 (Phase 4)
...
2. Modify `.github/workflows/publish.yml` similar to other services
3. Change Docker login from Docker Hub secrets to GitHub Container Registry
4. Update image tags to `ghcr.io/adempiere/adempiere-report-engine-service`
5. Create GitHub Release with tag (suggested: `alpine-1.3.8`)
6. Verify publication: `docker pull ghcr.io/adempiere/adempiere-report-engine-service:alpine-1.3.8`
7. Update `adempiere-ui-gateway` env_template.env line 248 (Phase 4)
...
2. Modify `.github/workflows/publish.yml` similar to other services
3. Change Docker login from Docker Hub secrets to GitHub Container Registry
4. Update image tags to `ghcr.io/adempiere/adempiere-landing-page`
5. Create GitHub Release with tag (suggested: `alpine-1.0.4`)
6. Verify publication: `docker pull ghcr.io/adempiere/adempiere-landing-page:alpine-1.0.4`
7. Update `adempiere-ui-gateway` env_template.env line 317 (Phase 4)
...
- **After:** `S3_GATEWAY_RS_IMAGE="ghcr.io/adempiere/adempiere-s3-gateway:<version>"`
- **Action:** Edit line 117

#### Change 6: Dictionary Service Image
- **Line:** 221
- **Before:** `DICTIONARY_RS_IMAGE="openls/dictionary-rs:1.5.5"`
- **After:** `DICTIONARY_RS_IMAGE="ghcr.io/adempiere/adempiere-dictionary-service:<version>"`
...
**⚠️ Prerequisites:** Source repositories must be identified first.

**Service 6: s3-gateway-rs → adempiere-s3-gateway**
- Release tag: `1.2.8`
- Verify: `docker pull ghcr.io/adempiere/adempiere-s3-gateway:1.2.8`

**Service 7: dictionary-rs → adempiere-dictionary-service**
- Release tag: `1.5.6`
- Verify: `docker pull ghcr.io/adempiere/adempiere-dictionary-service:1.5.6`

**Service 8: adempiere-report-engine-service**
- Release tag: `alpine-1.3.8`
- Verify: `docker pull ghcr.io/adempiere/adempiere-report-engine-service:alpine-1.3.8`
...
- **Steps:**
  ...
  5. Update line 117: S3 gateway → `ghcr.io/adempiere/adempiere-s3-gateway:1.2.8`
  6. Update line 221: Dictionary → `ghcr.io/adempiere/adempiere-dictionary-service:1.5.6`
  7. Update line 248: Report engine → `ghcr.io/adempiere/adempiere-report-engine-service:alpine-1.3.8`
...
1. **Pull All Images**
   ...
   docker pull ghcr.io/adempiere/adempiere-grpc-server:3.9.4.001-1.0.31
   docker pull ghcr.io/adempiere/adempiere-vue:0.0.6
   docker pull ghcr.io/adempiere/adempiere-s3-gateway:1.2.8
   docker pull ghcr.io/adempiere/adempiere-dictionary-service:1.5.6
   docker pull ghcr.io/adempiere/adempiere-report-engine-service:alpine-1.3.8
